 ...
 *
 *****************************************************************************/
#ifndef EFR32MG24_GPIO_H
#define EFR32MG24_GPIO_H
...
typedef struct {
  ...
  uint32_t                  RESERVED10[560U];        /**< Reserved for future use                            */
  ...
  uint32_t                  RESERVED21[560U];        /**< Reserved for future use                            */
  ...
  uint32_t                  RESERVED32[560U];        /**< Reserved for future use                            */
