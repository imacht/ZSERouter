...
///  Labs' 32-bit MCUs and SoCs. The EUSART can be used as a UART and can,
...
///  and IrDA devices.
///
///  The EUSART has a wide selection of operating modes, frame formats, and baud rates.
...
///  The @ref <b>EUSART_EM2_CAPABLE()</b> and @ref <b>EUSART_NOT_EM2_CAPABLE()</b> macros can be used
