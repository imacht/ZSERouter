 ...
 * always
 */
WEAK(void emberAfEnergyScanResultCallback(int8u channel,
                                          int8s rssi))
{
}
 ...
 * Ver.: always
 */
WEAK(void emberAfNetworkFoundCallback(EmberZigbeeNetwork* networkFound,
                                      int8u lqi,
                                      int8s rssi))
{
}
 ...
 */
WEAK(void emberAfScanCompleteCallback(int8u channel,
                                      EmberStatus status))
{
}
 ...
 * @param status The status of the scan.  Ver.: always
 */
WEAK(void emberAfScanErrorCallback(EmberStatus status))
{
}
...
#else
WEAK(boolean emberAfStackStatusCallback(EmberStatus status))
{
  return false;
}
#endif
 ...
 */
WEAK(void emberAfUnusedPanIdFoundCallback(EmberPanId panId,
                                          int8u channel))
{
}
 ...
 */
WEAK(void emberAfZigbeeKeyEstablishmentCallback(EmberEUI64 partner,
