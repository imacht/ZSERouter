 ...
 * perform certificate based key establishment (CBKE), which performs
 * mutual authentication and establishes a symmetric APS link key.
 * Direct CBKE between any two non-TC devices is supported once the two
 * devices have completed partner link key exchange via Trust Centre.
 *
 */
