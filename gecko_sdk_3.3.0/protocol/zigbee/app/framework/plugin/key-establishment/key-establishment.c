...
extern EmberAfStatus emberAfKeyEstablishmentClusterServerCommandParse(EmberAfClusterCommand * cmd);
extern EmberAfStatus emberAfKeyEstablishmentClusterClientCommandParse(EmberAfClusterCommand * cmd);
#else // !UC_BUILD
                                    ...
                                    uint8_t delayInSec)
{
  ...
  if (keyEstPartner.isIntraPan) {
    ...
    return emberAfPluginKeyEstablishmentEventCallback(message,
                                                      !keyEstPartner.isInitiator,
    ...
    emberAfKeyEstablishmentClusterPrintln("");
    return emberAfPluginKeyEstablishmentInterPanCallback(message,
                                                         !keyEstPartner.isInitiator,
