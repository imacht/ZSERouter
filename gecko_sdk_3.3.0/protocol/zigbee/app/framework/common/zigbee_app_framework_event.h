 ...
 * @brief ZigBee events related APIs.
 *
...
#define sl_zigbee_event_set_delay_qs(event, delay) \
  emberEventSetDelayMs(sli_zigbee_get_event_ptr((event), 0xFF), (delay << 8))

#define sl_zigbee_event_set_delay_minutes(event, delay) \
  emberEventSetDelayMs(sli_zigbee_get_event_ptr((event), 0xFF), (delay << 16))
...
#define sl_zigbee_endpoint_event_set_delay_qs(event, endpoint, delay) \
  emberEventSetDelayMs(sli_zigbee_get_event_ptr((event), (endpoint)), (delay << 8))

#define sl_zigbee_endpoint_event_set_delay_minutes(event, endpoint, delay) \
  emberEventSetDelayMs(sli_zigbee_get_event_ptr((event), (endpoint)), (delay << 16))
