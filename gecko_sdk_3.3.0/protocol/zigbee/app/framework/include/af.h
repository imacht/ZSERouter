...
/**
 * @brief Run the application framework's
...
/**
 * @brief Set the ::EmberEventControl to run "delayMs" milliseconds in the
...
/**
 * @brief Set the ::EmberEventControl to run "delayQs" quarter seconds in the
...
/**
 * @brief Set the ::EmberEventControl to run "delayM" minutes in the future.
...
/**
 * @brief Set the ::EmberEventControl for the current network, and only
...
/**
 * @brief Return true if the event for the current network, and only the
...
/**
 * @brief Set the ::EmberEventControl for the current network, and only the
...
/**
 * @brief Set the ::EmberEventControl for the specified endpoint as inactive.
 * See ::emberEventControlSetInactive.
 */
EmberStatus emberAfEndpointEventControlSetInactive(EmberEventControl *controls,
                                                   uint8_t endpoint);
/**
 * @brief Return true if the event for the current number is active.  See
 * ::emberEventControlGetActive.
 */
bool emberAfEndpointEventControlGetActive(EmberEventControl *controls,
                                          uint8_t endpoint);
/**
 * @brief Set the ::EmberEventControl for the specified endpoint to run at the
...
EmberStatus emberAfEndpointEventControlSetActive(EmberEventControl *controls,
                                                 uint8_t endpoint);
/**
 * @brief Set the ::EmberEventControl for the specified endpoint to run
...
#ifndef UC_BUILD
/** @brief In effect, serve as the application main.
 */
