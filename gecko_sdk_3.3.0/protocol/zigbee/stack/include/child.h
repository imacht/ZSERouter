...
/** @brief Adds a child to the child/neighbor table only on SoC,
 ...
 *
 * @return An ::EmberStatus value.
 * - ::EMBER_SUCCESS - This node has been susseccfully added.
...
/** @brief Removes a node from child/neighbor table only on SoC,
 * allowing direct manipulation of these tables by the application.
 * This can affect the network functionality, and needs to be used wisely.
 *
...
/** @brief Removes a neighbor from neighbor table only on SoC,
