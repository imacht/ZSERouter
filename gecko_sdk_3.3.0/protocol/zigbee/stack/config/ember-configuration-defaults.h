...
#if defined(SL_CATALOG_ZIGBEE_PRO_LEAF_STACK_PRESENT)
...
// TODO: handle special casing for NCP && EMBER_AF_PLUGIN_MULTI_PAN_LIBRARY
// if still needed
...
#if (defined(EMBER_NO_STACK) && !defined(EMBER_ZC_AND_ZR_DEVICE_COUNT))
