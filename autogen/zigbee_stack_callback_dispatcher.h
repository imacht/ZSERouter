...
void emAfStackStatusCallback(
      ...
      EmberStatus status)
;
void emberAfPluginNetworkFindStackStatusCallback(
      // Stack status. One of the following: EMBER_NETWORK_UP,
      // EMBER_NETWORK_DOWN, EMBER_JOIN_FAILED, EMBER_MOVE_FAILED
      EmberStatus status)
;
...
void emAfEnergyScanResult(
      ...
      int8_t maxRssiValue)
;
void emAfPluginFormAndJoinEnergyScanResultCallback(
      // The 802.15.4 channel number that was scanned.
      uint8_t channel,
      // The maximum RSSI value found on the channel.
      int8_t maxRssiValue)
...
void emAfNetworkFound(
      ...
      int8_t rssi)
;
void emAfPluginFormAndJoinNetworkFoundCallback(
      // The parameters associated with the network found.
      EmberZigbeeNetwork *networkFound,
      // The link quality indication of the network found.
      uint8_t lqi,
...
void emAfScanComplete(
      ...
      EmberStatus status)
;
void emAfPluginFormAndJoinScanCompleteCallback(
      // The channel on which the current error occurred. Undefined for the case
      // of EMBER_SUCCESS.
      uint8_t channel,
      // The error condition that occurred on the current channel. Value will be
...
void emAfUnusedPanIdFound(
      ...
      uint8_t channel)
;
void emAfPluginFormAndJoinUnusedPanIdFoundCallback(
      // The unused panID which has been found.
      EmberPanId panId,
      // The channel that the unused panID was found on.
      uint8_t channel)
;
void emAfPluginNetworkFindUnusedPanIdFoundCallback(
      // The unused panID which has been found.
      EmberPanId panId,
      // The channel that the unused panID was found on.
      uint8_t channel)
...
void emAfScanError(
      ...
      EmberStatus status)
;
void emAfPluginNetworkFindScanErrorCallback(
      // The error status of a scan
      EmberStatus status)
;
